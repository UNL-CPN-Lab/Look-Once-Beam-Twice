...
# This file lives in outdoor/fullsweep/. Add the repo root so
...
# # Example Usage:
# sweep_directory_path = "<DATA_ROOT>/mmWaveSSD/Schorr_Center/Full_Sweep_Experiment/sweepData/sc_jun17_gain3db_3m_t3" # linux
