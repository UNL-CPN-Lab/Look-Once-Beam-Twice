...
# Experiment list
base_filenames = [
    "sc_jul13_gain9db_12db_16m_t1", "sc_jul13_gain9db_12db_16m_t1", "sc_jul13_gain9db_12db_16m_t1",
    "sc_jul13_gain9db_12db_16m_t1", "sc_jul13_gain9db_12db_16m_t1",
...
labels = [
    "VIBE-YOLOR:11dB SNR Th.", "VIBE-YOLOR:14dB SNR Th.", "VIBE-YOLOR:17dB SNR Th.",
    "VIBE-YOLOR:20dB SNR Th.", "VIBE-YOLOR:23dB SNR Th.",
    "VIBE-YOLOR:11dB SNR Th.", "VIBE-YOLOR:14dB SNR Th.", "VIBE-YOLOR:17dB SNR Th.",
    "VIBE-YOLOR:20dB SNR Th.", "VIBE-YOLOR:23dB SNR Th.",
    "VIBE-YOLOR:11dB SNR Th.", "VIBE-YOLOR:14dB SNR Th.", "VIBE-YOLOR:17dB SNR Th.",
    "VIBE-YOLOR:20dB SNR Th.", "VIBE-YOLOR:23dB SNR Th."
...
# Base folder
base_path = "yolor_Results"
plt.figure(figsize=(12, 8))

# Group for legend
grouped_labels = {
    "VIBE-YOLOR:11dB SNR Th.": [],
    "VIBE-YOLOR:14dB SNR Th.": [],
    "VIBE-YOLOR:17dB SNR Th.": [],
    "VIBE-YOLOR:20dB SNR Th.": [],
    "VIBE-YOLOR:23dB SNR Th.": []
}
...
# === Add VIBE-YOLOR SNR Threshold Header ===
custom_legend_lines.append(Line2D([0], [0], linestyle='None'))  # Spacer / header
custom_legend_labels.append("VIBE-YOLOR SNR Th.")
...
plt.xlabel("Margin from Threshold", fontsize=22, fontweight='bold')
plt.ylabel("CDF", fontsize=22, fontweight='bold')
plt.xticks(np.arange(-40, 45, 10), fontsize=22, fontweight='bold')
...
# Save
output_base = "combined_snr_minus_threshold_cdf_yolor"
