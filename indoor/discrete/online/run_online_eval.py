...
# === SCRIPTS TO RUN ===
SCRIPTS = [
    "online_main_basic.py"   # Basic online beamforming script
    # "online_main_corrective_mavg.py", # Online script with moving average correction
    # "online_main_corrective_mlp.py" # Online script with mlp correction
]

# === PARAMETERS TO SWEEP ===
ROTOR_SPEEDS = [ 1,2, 5]              # Rotor speeds (in sec/deg) to evaluate
SNR_FACTORS = [0.4,0.6,0.8]         # SNR threshold factors to evaluate
