"""Orchestrator for VIBE-YOLOR offline indoor evaluations (continuous rotor).
...
`continuous_offline_main_basic.py` for the live experiment. The source
...
Run from this folder: `python3 offline_automatic_basic_main.py`.
...
ONLINE_SCRIPT = "continuous_offline_main_basic.py"
...
def main():
        ...
        # Edit to match the experiment ID of your own captured sweep.
        ...
        for snr_quantile, rotor_speed in itertools.product(SNR_QUANTILE, ROTOR_SPEEDS):
            ...
            os.environ["GROUND_TRUTH_PATH"] = os.path.join(
                PROJECT_ROOT,
                "indoor", "continuous", "offline", "automatic_indoor_evaluations_basic",
            ...
            test_number = f"off_OAKD_AB{experiment_counter}"
