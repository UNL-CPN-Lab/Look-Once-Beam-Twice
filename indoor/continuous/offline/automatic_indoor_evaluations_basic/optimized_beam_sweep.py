...
def rx_host(usrp, rx_streamer, start_time, child_rx, child_tx, experiment_dir, sample_size):
    ...
    # Sweep from 0 to 180
    for target_angle in range(40,141, 1):   # forward rotation
        ...
        tx_beam_center = 32
        # tx_beam_range = range(max(1, tx_beam_center - 15), min(64, tx_beam_center + 15))
        tx_beam_range = range(1,64)
