...
# experiment_name = "sc_jul20_gain8db_3m_off_MAVG15" 

# === Paths and Constants ===
project_dir = os.path.join(PROJECT_ROOT, "indoor", "continuous", "offline", "automatic_indoor_evaluations_mavg_absent","Adaptive_Beamforming_SC")
...
summary_csv_path = os.path.join(summary_dir, f"online_evaluation_experiments_results_summary_{date}.csv")
