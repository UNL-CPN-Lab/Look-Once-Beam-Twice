...
# experiment_name = "sc_jul20_gain8db_3m_off_MAVG11" 

# === Paths and Constants ===
project_dir = os.path.join(PROJECT_ROOT, "indoor", "continuous", "offline", "automatic_indoor_evaluations_mavg","Adaptive_Beamforming_SC")
