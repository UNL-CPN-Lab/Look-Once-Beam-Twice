...
# === CONFIGURATION ===
exp_base_path = "<DATA_ROOT>/mmwave_vision_research/evk06002/eder_evk-Release_20220406_1715/optimized/indoor/continuous/offline/automatic_indoor_evaluations_mavg/Adaptive_Beamforming_SC"
output_csv_path = "<DATA_ROOT>/mmwave_vision_research/evk06002/eder_evk-Release_20220406_1715/optimized/indoor/continuous/offline/automatic_indoor_evaluations_mlp/offset_dataset_sc_jul20_offline.csv"
...
for t in range(1, 15, 1):
    experiment_name = f"sc_jul20_gain8db_3m_off_MAVG{t}"
