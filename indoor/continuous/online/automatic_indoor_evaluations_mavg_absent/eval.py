...
# experiment_name = "sc_jun22_gain8db_3m_MAVG15" 

# === Paths and Constants ===
project_dir = os.path.join(PROJECT_ROOT, "indoor", "continuous", "online", "automatic_indoor_evaluations_mavg_absent","Adaptive_Beamforming_SC")
