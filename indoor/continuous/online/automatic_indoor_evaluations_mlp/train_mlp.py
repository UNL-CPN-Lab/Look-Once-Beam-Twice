...
def train_offset_model(dataset_path, num_epochs=200, batch_size=32, learning_rate=0.001, test_split=0.2):
    ...
    # Save artifacts
    torch.save(model.state_dict(), "offset_mlp_model_sc_jul23_oakd.pt")
    joblib.dump(scaler, "offset_scaler_sc_jul23_oakd.pkl")

    return model, scaler, y_test, y_pred, y

# Train
model, scaler, y_test, y_pred, y_all = train_offset_model("offset_dataset_sc_jul23_oakd.csv")
