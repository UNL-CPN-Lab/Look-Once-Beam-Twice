...
# === CONFIGURATION ===
exp_base_path = "<DATA_ROOT>/mmwave_vision_research/evk06002/eder_evk-Release_20220406_1715/optimized/indoor/continuous/online/automatic_indoor_evaluations_mavg/Adaptive_Beamforming_SC"
output_csv_path = "<DATA_ROOT>/mmwave_vision_research/evk06002/eder_evk-Release_20220406_1715/optimized/indoor/continuous/online/automatic_indoor_evaluations_mlp/offset_dataset_sc_jul23_oakd.csv"
...
for t in range(1, 15, 1):
    experiment_name = f"sc_jul23_gain8db_3m_QT_OAKD_MAVG{t}"
