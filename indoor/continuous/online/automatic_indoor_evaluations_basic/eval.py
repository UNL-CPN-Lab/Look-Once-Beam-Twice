...
experiment_name = "sc_jul23_gain8db_3m_QT_OAKD_AB15"  

# === Paths and Constants ===
project_dir = os.path.join(PROJECT_ROOT, "indoor", "continuous", "online", "automatic_indoor_evaluations_basic","Adaptive_Beamforming_SC")
